...
# ファイルパスを絶対パスに変更する
data_path2 = os.path.join(os.path.dirname(__file__),"../data/population_prefecture_data/population.csv")
df0 = pd.read_csv(data_path2,encoding='shift-jis',index_col=1)
